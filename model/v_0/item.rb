...
domain :Items do
  ...
  datatype(:ItemType, extends: :Classified,
    ...
    attribute :additional_classification_schemes, ITEM_SCHEMES, ONE_TO_MANY,
              "Additional ways to classify the item",
              example: "[#{CPV.uri}]"
    attribute :additional_classifications, String, ONE_TO_MANY, "Code within the primary scheme defining this type. Each code should have a prefix identifying the scheme",
              example: "[CPV:37000000-8]"
  ...
  datatype(:Item,
    ...
    attribute :type_id, String, " type of the item ", links: Items::ItemType, example: "CPV:37000000-8:CCS:2019-01:1"
