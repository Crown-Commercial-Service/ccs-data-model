...
|---------|----|------------|-----------|
|sector_scheme|sector_scheme(https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/ccs_sector_codes,https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/sector_scheme#other)|*|The sector scheme id|
|sector_id|String|*|The sector scheme ids that define to whom the item may be sold. Prefix must match one of the schemes.|
|location_scheme|location_scheme(https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/location_scheme#nuts_2016,https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/location_scheme#postcode_raius)|*|The schemes for identifying locations|
|location_id|String|*|The location scheme ids that defines  where the items can be offered.|
## Agreement extends Register::Record
  General definition of Commercial Agreements

|attribute|type|multiplicity|description|
|---------|----|------------|-----------|
|version_id|String|1|UUID of this version of the entry|
|supercedes_id|String|1|UUID of this version superceded|
|date_added|DateTime|1|Date of creation or update|
|checksum|String|1|MD5|
|kind|agreement_type_codes(framework,lot,callof,contract)|1|Kind of agreement, such as Framework, Lot,Contract. Lots are considered separateagreements, but link to their owning framework agreement. Similarly Contracts should link to anylot that they are based on. See https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/agreement_type_codes for details.|
...
|restriction|Agreements::Restriction|0..1|Restrictions that may apply|
...
|org_name|String|1||
|sector_scheme|sector_scheme(https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/ccs_sector_codes,https://github.com/Crown-Commercial-Service/ccs-data-model/tree/master/gen/reference_data/v0/sector_scheme#other)|*||
|sector|String|*||
